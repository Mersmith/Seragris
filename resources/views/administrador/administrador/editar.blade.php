<x-administrador-layout>
    @section('tituloPagina', 'EDITAR ADMINISTRADOR')
    <!--Titulo-->
    ...
    <div class="contenedor_paginas_administrador">
        ...
        <div class="contenedor_1_elementos">
            <label class="label_principal">             
                ...
                {!! Form::text('nombre', $usuario->administrador->nombre,  ['placeholder' => 'Escribe el nombre.']) !!}
                @error('nombre')
                    <span>{{ $message }}</span>
                @enderror
            </label>
        ...
        <div class="contenedor_1_elementos">
            <label class="label_principal">
                ...
                {!! Form::email('email', $usuario->email, ['placeholder' => 'Escribe el correo.']) !!}
                @error('email')
                    <span>{{ $message }}</span>
                @enderror
            </label>
        ...
        <div class="contenedor_1_elementos">
            <label class="label_principal">
                ...
                {!! Form::password('password', $usuario->password, ['placeholder' => 'Escribe la contraseña.']) !!}
                @error('password')
                    <span>{{ $message }}</span>
                @enderror
            </label>
