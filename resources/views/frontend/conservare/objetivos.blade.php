<div class="conservare_objetivos">
    <div class="objetivos">
        <div>
            <h3>OBJETIVOS</h3>
            <table>
                <tr>
                    ...
                    <td>
                        <p>
                            Brindar soluciones integrales a los diversos clientes del sector agrícola e industrial,
                            proporcionando productos y servicios de alta calidad, que cubran las expectativas nacionales
                            e internacionales, cuidando el medio ambiente.</p>
                    </td>
                </tr>
                <tr>
                    <td><i class="fa-solid fa-bullseye"></i></td>
